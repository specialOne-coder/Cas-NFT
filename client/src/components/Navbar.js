...
import { FaArchive, FaBurn, FaDropbox, FaHammer, FaSellcast, FaStreetView} from "react-icons/fa";
        ...
        {toggleMenu && (
          ...
          >
            ...
            <li className="mx-4 cursor-pointer">
              <button
                className='flex flex-row items-center my-2 border-solid border-2  mr-2 bg-[#fff] rounded-md cursor-pointer h-8 w-40 place-content-center'>
                <FaDropbox fontSize={20} className="text-white text-center pr-1" color="#2546bd" />
                <p className="text-[#2546bd] font-bold  pr-1 pl-1">
                <Link to="/airdrop"> Airdrop</Link>
                </p>
              </button>
            ...
            <li className="mx-4 cursor-pointer">
              <button
                className='flex flex-row items-center my-2 border-solid border-2  mr-2 bg-[#fff] rounded-md cursor-pointer h-8 w-40 place-content-center'>
                <FaBurn fontSize={20} className="text-white text-center pr-1" color="#2546bd" />
                <p className="text-[#2546bd] font-bold  pr-1 pl-1">
                <Link to="/burn"> Burn</Link>
                </p>
              </button>
            ...
            <li className="mx-4 cursor-pointer">
              <button
                className='flex flex-row items-center my-2 border-solid border-2  mr-2 bg-[#fff] rounded-md cursor-pointer h-8 w-40 place-content-center'>
                <FaSellcast fontSize={20} className="text-white text-center pr-1" color="#2546bd" />
                <p className="text-[#2546bd] font-bold  pr-1 pl-1">
                <Link to="/mynfts">MyNFTs</Link>
                </p>
              </button>
